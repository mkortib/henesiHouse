    ...
    <div class="w">
                ...
                if ( have_posts() ) :
                    while ( $flats->have_posts() ) :
                        ...
                        <div class="single_layout-bl">
                            ...
                            <h3><?php echo __(' [:ua]1-кімнатна квартира[:ru]1-комнатная квартира[:en]1 room[:]' .' (' . esc_html( get_the_title()) . ')' ); ?></h3>
                            <div class="info">
        ...
        <section class="add_descr">
            <div class="cnt txt close">
                <?php echo __('[:ua]Якщо Ви зацікавилися, де здійснюється продаж однокімнатних квартир, 
                Вам варто придивитися до житлового комплексу Хенесi Хаус на вулиці Нагірна, 18/16 в Києві. 
                Продумане до дрібниць якісне, екологічно чисте однокімнатне житло, відповідає всім вимогам сучасної 
                людини. <br>
                Перегляд і придбання квартири не такий вже і складний процес, адже у нас на сайті розписаний 
                детальний план кожної оселі. З такими привілеями можна в зручному режимі вибрати відповідний 
                метраж і купити квартиру. З нами Ви отримуєте сучасні однокімнатні апартаменти в центрі столиці 
                за невеликі гроші.
                [:ru]Если Вы заинтересовались, где осуществляется продажа однокомнатных квартир, 
                Вам стоит присмотреться к жилищному комплексу Хенеси Хаус на улице Нагорная, 18/16 в Киеве. 
                Продуманное до мелочей качественное, экологически чистое однокомнатное жилье, отвечает всем 
                требованиям современного человека. <br>
                Просмотр и покупка квартиры не такой уж и сложный процесс, ведь у нас на сайте расписан 
                детальный план каждого жилища. С такими привилегиям можно в удобном режиме выбрать подходящий 
                метраж и купить квартиру. С нами Вы получаете современные однокомнатные апартаменты в центре 
                столицы за небольшие деньги.
                [:en]More[:]'); ?>
            </div>
            <div class="btn">
                <p class="btn_n">
