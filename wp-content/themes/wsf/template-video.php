...
<div id="video-page">
    <div class="w">
        <section class="top flex">
            ...
            <div class="top_cnt cnt">
                <h1 class="title"><?php echo  __('[:ru]Видеообзор ЖК Хенеси Хаус[:ua]Відеоогляд ЖК Хенесі Хаус[:]')?></h1>
                <iframe src="https://www.youtube.com/embed/3WneOk5J5-A?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" class="video" allowfullscreen></iframe>
            </div>
        </section>
        <section class="cb_bl">
